...
@testset "LogNormal" begin
    ...
    @test logdiffcdf(LogNormal(), AbstractFloat(expAbstractFloatbstractFloat(exp(3))) ≈ -6.6079385945968929 rtol=1e-12
    ...
    @test isnan_type(AbstractFloat, invlogcdf(LogNormal(), NaN))

    @test invlogccdf(LogNormal(), -Inf) === Inf
    @test isnan_type(AbstractFloat, invlogccdf(LogNormal(), NaN))
...
@testset "LogNormal type inference" begin
    ...
    @test isnan_type(AbstractFloat, @inferred(pdf(LogNormal(0.0, 0.0), NaN)))
    @test isnan_type(AbstractFloat, @inferred(pdf(LogNormal(NaN, 0.0), 1.0f0)))
    @test isnan_type(AbstractFloat, @inferred(pdf(LogNormal(NaN, 0.0), 0.0f0)))
    @test isnan_type(AbstractFloat, @inferred(pdf(LogNormal(NaN, 0.0), -1.0f0)))
    ...
    @test isnan_type(AbstractFloat, @inferred(pdf(LogNormal(0 // 1, 0 // 1), NaN)))
    ...
    @test isnan_type(AbstractFloat, @inferred(logpdf(LogNormal(0.0, 0.0), NaN)))
    @test isnan_type(AbstractFloat, @inferred(logpdf(LogNormal(NaN, 0.0), 1.0f0)))
    @test isnan_type(AbstractFloat, @inferred(logpdf(LogNormal(NaN, 0.0), 0.0f0)))
    @test isnan_type(AbstractFloat, @inferred(logpdf(LogNormal(NaN, 0.0), -1.0f0)))
    ...
    @test @inferred(logpdf(LogNormal(0 // 1, 0 // 1), -1 // 1)) === -Inf
    @test isnan_type(AbstractFloat, @inferred(logpdf(LogNormal(0 // 1, 0 // 1), NaN)))
    ...
    @test isnan_type(AbstractFloat, @inferred(cdf(LogNormal(0.0, 0.0), NaN)))
    @test isnan_type(AbstractFloat, @inferred(cdf(LogNormal(NaN, 0.0), 1.0f0)))
    @test isnan_type(AbstractFloat, @inferred(cdf(LogNormal(NaN, 0.0), 0.0f0)))
    @test isnan_type(AbstractFloat, @inferred(cdf(LogNormal(NaN, 0.0), -1.0f0)))
    ...
    @test isnan_type(AbstractFloat, @inferred(cdf(LogNormal(0 // 1, 0 // 1), NaN)))
    ...
    @test isnan_type(AbstractFloat, @inferred(logcdf(LogNormal(0.0, 0.0), NaN)))
    @test isnan_type(AbstractFloat, @inferred(logcdf(LogNormal(NaN, 0.0), 1.0f0)))
    @test isnan_type(AbstractFloat, @inferred(logcdf(LogNormal(NaN, 0.0), 0.0f0)))
    @test isnan_type(AbstractFloat, @inferred(logcdf(LogNormal(NaN, 0.0), -1.0f0)))
    ...
    @test isnan_type(AbstractFloat, @inferred(logcdf(LogNormal(0 // 1, 0 // 1), NaN)))
    ...
    @test isnan_type(AbstractFloat, @inferred(ccdf(LogNormal(0.0, 0.0), NaN)))
    @test isnan_type(AbstractFloat, @inferred(ccdf(LogNormal(NaN, 0.0), 1.0f0)))
    @test isnan_type(AbstractFloat, @inferred(ccdf(LogNormal(NaN, 0.0), 0.0f0)))
    @test isnan_type(AbstractFloat, @inferred(ccdf(LogNormal(NaN, 0.0), -1.0f0)))
    ...
    @test isnan_type(AbstractFloat, @inferred(ccdf(LogNormal(0 // 1, 0 // 1), NaN)))
    ...
    @test isnan_type(AbstractFloat, @inferred(logccdf(LogNormal(0.0, 0.0), NaN)))
    @test isnan_type(AbstractFloat, @inferred(logccdf(LogNormal(NaN, 0.0), 1.0f0)))
    @test isnan_type(AbstractFloat, @inferred(logccdf(LogNormal(NaN, 0.0), 0.0f0)))
    @test isnan_type(AbstractFloat, @inferred(logccdf(LogNormal(NaN, 0.0), -1.0f0)))
    ...
    @test isnan_type(AbstractFloat, @inferred(logccdf(LogNormal(0 // 1, 0 // 1), NaN)))
    ...
    @test isnan_type(AbstractFloat, @inferred(quantile(LogNormal(1.0f0, 0.0), NaN)))
    ...
    @test isnan_type(AbstractFloat, @inferred(cquantile(LogNormal(1.0f0, 0.0), NaN)))
    ...
    @test isnan_type(AbstractFloat, @inferred(logccdf(LogNormal(0.0, 1.0), NaN)))
    @test isnan_type(AbstractFloat, @inferred(logccdf(LogNormal(NaN, 1.0), 1.0f0)))
    @test isnan_type(AbstractFloat, @inferred(logccdf(LogNormal(NaN, 1.0), 0.0f0)))
    @test isnan_type(AbstractFloat, @inferred(logccdf(LogNormal(NaN, 1.0), -1.0f0)))
    ...
    @test isnan_type(AbstractFloat, @inferred(gradlogpdf(LogNormal(0 // 1, 1 // 1), NaN)))
