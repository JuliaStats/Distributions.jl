...
@testset "AffineDistribution" begin
    ...
    @test ls_norm isa LocationScale{Float64, ContinuousSupport, Normal{Float64}}
    @test ls_norm isa Distributions.AffineDistribution{Float64, ContinuousSupport, Normal{Float64}}
end
