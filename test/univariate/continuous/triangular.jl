...
function convertstr(t::DataType, x::T) where T<:Real
    ...
    t == Rational{Int} && return convert(Rational{Int}, x)
...
types = [Float16, Float32, Float64, BigFloat, Rational{Int}
        , Int8, Int16, Int32, Int64, Int128, BigInt
        , UInt8, UInt16, UInt32, UInt64, UInt128] #Bool
n = length(types)^2
typeslist = Array{DataType}(undef, n, 2)
j = 1
...
@testset "triangular" begin
    ...
    @testset "regular_triangle" begin
        ...
        for j = 1:n
            ...
            zxlowt = convertstr(typex, xlowt)
            zxhight = convertstr(typex, xhight)
            ...
            @inferred pdf(TriangularDist(za, zb, zc), zxlowt)
            @inferred pdf(TriangularDist(za, zb, zc), zxhight)
            ...
            @inferred cdf(TriangularDist(za, zb, zc), zxlowt)
            @inferred cdf(TriangularDist(za, zb, zc), zxhight)
