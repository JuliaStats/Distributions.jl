...
@testset "Normal" begin
    @test isa(convert(Normal{AbstractFloat}, Float16(0), Float16(1)),
              Normal{AbstractFloat})
    ...
    @test logdiffcdf(Normal(), AbstractFloat(5), AbstractFloat(3)) ≈ -6.6079385945968929 rtol=1e-12
    let d = Normal(AbstractFloat(0), AbstractFloat(1)), x = AbstractFloat(-60), y = AbstractFloat(-60.001)
    ...
    @test_throws MethodError logdiffcdf(Normal(), Float32(2), AbstractFloat(1))
    ...
    @test isnan_type(AbstractFloat, invlogcdf(Normal(), NaN))
    @test Inf === invlogccdf(Normal(), -Inf)
    @test isnan_type(AbstractFloat, invlogccdf(Normal(), NaN))
...
@testset "Normal logpdf & pdf type inference" begin
    ...
    @test isnan_type(AbstractFloat, @inferred(quantile(Normal(1.0f0, 0.0), NaN)))
    ...
    @test isnan_type(AbstractFloat, @inferred(cquantile(Normal(1.0f0, 0.0), NaN)))
