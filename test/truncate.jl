...
function verify_and_test(d::UnivariateDistribution, dct::Dict, n_tsamples::Int)
    ...
    for pt in pts
        ...
        if !isa(d, Distributions.Truncated{Distributions.StudentizedRange{Float64},Distributions.ContinuousSupport})
        ...
        if !any(T -> d isa T, [Distributions.Truncated{Distributions.NoncentralChisq{Float64},Distributions.ContinuousSupport, Float64},
                           ...
                           Distributions.Truncated{Distributions.Rician{Float64},Distributions.ContinuousSupport, Float64}])
