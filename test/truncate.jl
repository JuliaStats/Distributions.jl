...
@testset "#1328" begin
    ...
    @test logsumexp(logpdf(dist, x) for x = 0:1000) ≈ 0 atol = 1e-15
    @test logsumexp(logpdf(dist_zeroinflated, x) for x = 0:1000) ≈ 0 atol = 1e-15
    @test logsumexp(logpdf(dist_zerotruncated, x) for x = 0:1000) ≈ 0 atol = 1e-15
    @test logsumexp(logpdf(dist_zeromodified, x) for x = 0:1000) ≈ 0 atol = 1e-15
end
end
