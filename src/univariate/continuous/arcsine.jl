...
Arcsine(a::Real, b::Real; check_args::Bool = true) =
    Arcsine(promote(a, b)...; check_args = check_args)
Arcsine(a::Integer, b::Integer; check_args::Bool = true) =
    Arcsine(float(a), float(b); check_args = check_args)
