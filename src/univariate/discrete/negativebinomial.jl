...
"""
@auto_hash_equals struct NegativeBinomial{T<:Real} <: DiscreteUnivariateDistribution
    r::T
    p::T
...
@auto_hash_equals struct RecursiveNegBinomProbEvaluator <: RecursiveProbabilityEvaluator
    r::Float64
    p0::Float64
end
