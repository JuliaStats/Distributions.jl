...
@deprecate expectation(distr::DiscreteUnivariateDistribution, g, epsilon) expectation(distr, g; epsilon=epsilon)
@deprecate expectation(distr::ContinuousUnivariateDistribution, g, epsilon) expectation(distr, g)
