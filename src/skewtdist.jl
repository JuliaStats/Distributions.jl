...
Skew T Distribution #1211
Closed
azev77 wants to merge 11 commits into JuliaStats:master from azev77:master
+182 −165
Conversation 1
Commits 11
Checks 0
...
File filter...
0 / 6 files viewed
164 docs/src/univariate.md
Viewed

This file was deleted.
4 src/Distributions.jl
Viewed
@@ -141,6 +141,8 @@ export
    Rayleigh,
    Semicircle,
    ...
    SymTriangularDist,
    TDist,
@@ -321,7 +323,7 @@ Supported distributions:
    ...
    QQPair, Rayleigh, Skellam, SkewNormal, SkewTDist, StudentizedRange, SymTriangularDist, TDist, TriangularDist,
...
124 src/univariate/continuous/skewtdist.jl
Viewed
@@ -0,0 +1,124 @@
"""
SkewTDist(ξ, ω, α, df)
