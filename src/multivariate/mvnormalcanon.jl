...
_rand!(rng::AbstractRNG, d::MvNormalCanon, x::AbstractVecOrMat) = add!(unwhiten_winv!(d.J, randn!(rng,x)), d.μ)
_rand!(d::MvNormalCanon, x::AbstractVecOrMat) = _rand!(Base.GLOBAL_RNG, d, x)
