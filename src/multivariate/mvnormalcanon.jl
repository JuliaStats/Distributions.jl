...
_showname(io::IO, ::IsoNormalCanon) = print(io, "IsoNormalCanon")
_showname(io::IO, ::DiagNormalCanon) = print(io, "DiagNormalCanon")
_showname(io::IO, ::FullNormalCanon) = print(io, "FullNormalCanon")

_showname(io::IO, ::ZeroMeanIsoNormalCanon) = print(io, "ZeroMeanIsoNormalCanon")
_showname(io::IO, ::ZeroMeanDiagNormalCanon) = print(io, "ZeroMeanDiagNormalCanon")
_showname(io::IO, ::ZeroMeanFullNormalCanon) = print(io, "ZeroMeanFullNormalCanon")
...
namedparams(d::MvNormalCanon) = (; d.μ, d.h, d.J)
