...
Generally, you don't have to implement every API method listed in the documentation. This package provides a series of generic functions that turn a small number of internal methods into user-end API methods. What you need to do is to implement this small set of internal methods for your distributions. It is recommended to ensure `hash` and `isequal` are defined for your distributions. This can be done using [AutoHashEquals.jl](https://github.com/andrewcooke/AutoHashEquals.jl).
